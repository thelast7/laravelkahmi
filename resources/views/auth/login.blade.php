...
<html lang="en">
<head>
  <title>KAHMIPRENEUR | LOG IN</title>
...
<body style="font-family: 'Open Sans', sans-serif;">
 ...
 <div class="container">
    ...
    <br>
    <input type="text" placeholder="Masukan User Name" name="uname" required>
    <br>
    <label><b>Password</b></label>
    <br>
    <input type="text" placeholder="Masukan Password" name="Kata Sandi" required>
    <br>
    <div class="clearfix">
