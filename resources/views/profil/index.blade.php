...
<html lang="en">
<head>
  <title>KAHMIPRENEUR | Profil</title>
  ...
  <link href='https://fonts.googleapis.com/css?family=Croissant+One|Black+Ops+One' rel='stylesheet' type='text/css'>
              ...
              <div class="collapse navbar-collapse" id="navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown ">
                    ...
                    <ul class="dropdown-menu menu-right">    
                      <li><a href="{{ url('PROFIL') }}">LOG OUT</a></li>
                    </ul>
                  </li>
...
<div class="container target">
    <div class="row">
        <div class="col-sm-10">
             <h1 style="font-family: 'Black Ops One', cursive;">Muhammad Taufik</h1>
  ...
  <br>
    <div class="row">
        <div class="col-sm-3">
            <!--left col-->
            <ul class="list-group">
                <li class="list-group-item text-muted" contenteditable="false"  style="font-family: /*'Croissant One'*/, cursive;">My Profile</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong >Name</strong></span> Muhammad Taufik</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong >User Name</strong></span> Taufik</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong >Alamat e-mail</strong></span> Muhammad Taufik@gmail.com</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong >No Handphone</strong></span> 087884324145</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Tanggal Lahir</strong></span> 3 Januari 1957</li>
                 <li class="list-group-item text-right"><span class="pull-left"><strong class="">Alamat Lengkap</strong></span> Jl. Kapitan RT 014/004 NO:34 Klender.</li>
                 <li class="list-group-item text-right"><span class="pull-left"><strong class="">Kota Asal</strong></span> DKI Jakarta</li>
                 <li class="list-group-item text-right"><span class="pull-left"><strong class="">Bidang Usaha</strong></span> Furniture</li>
             </ul>
        </div>
